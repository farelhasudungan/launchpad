import{c$ as p,cY as u,d1 as f,dh as g,cZ as a}from"./wallet.bundle.js";import{n as b,r as m,c as w}from"./index.chunk3.js";import{T as l}from"./index.chunk27.js";const C={interpolate(r,e,t){if(r.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=r[0]||0,i=r[1]||0,o=e[0]||0,s=e[1]||0;return t<n?o:t>i?s:(s-o)/(i-n)*(t-n)+o}},v=p`
  :host {
    width: 100%;
    display: block;
  }
