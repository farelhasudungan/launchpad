import{cV as A,cY as D,cF as $,cO as h,cZ as u,cM as V,cG as N,d1 as S,cH as M,dh as K,d4 as F,d5 as Q,cW as W,cX as H}from"./wallet.bundle.js";import{r as l,n as w,c as C}from"./index.chunk3.js";import"./index.chunk21.js";import"./index.chunk8.js";import{M as _}from"./index.chunk26.js";import"./index.chunk27.js";import{S as s}from"./SwapController.chunk.js";import"./index.chunk5.js";import"./index.chunk2.js";import"./index.chunk11.js";import"./index.chunk4.js";import"./index.chunk18.js";import"./if-defined.chunk.js";import"./ref.chunk.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",U=a==="x",L=n===",",O=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||U)&&e.preventDefault(),t==="0"&&!L&&!O&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(L||O)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!O&&!L&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
...
`;var T=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};const X=V.CONVERT_SLIPPAGE_TOLERANCE;let g=class extends D{constructor(){var t;super(),this.unsubscribe=[],this.networkName=(t=$.state.activeCaipNetwork)==null?void 0:t.name,this.detailsOpen=!1,this.sourceToken=s.state.sourceToken,this.toToken=s.state.toToken,this.toTokenAmount=s.state.toTokenAmount,this.sourceTokenPriceInUSD=s.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=s.state.toTokenPriceInUSD,this.priceImpact=s.state.priceImpact,this.maxSlippage=s.state.maxSlippage,this.networkTokenSymbol=s.state.networkTokenSymbol,this.inputError=s.state.inputError,this.unsubscribe.push(s.subscribe(o=>{this.sourceToken=o.sourceToken,this.toToken=o.toToken,this.toTokenAmount=o.toTokenAmount,this.priceImpact=o.priceImpact,this.maxSlippage=o.maxSlippage,this.sourceTokenPriceInUSD=o.sourceTokenPriceInUSD,this.toTokenPriceInUSD=o.toTokenPriceInUSD,this.inputError=o.inputError}))}render(){const t=this.toTokenAmount&&this.maxSlippage?h.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const o=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};g.styles=[G];T([l()],g.prototype,"networkName",void 0);T([w()],g.prototype,"detailsOpen",void 0);T([l()],g.prototype,"sourceToken",void 0);T([l()],g.prototype,"toToken",void 0);T([l()],g.prototype,"toTokenAmount",void 0);T([l()],g.prototype,"sourceTokenPriceInUSD",void 0);T([l()],g.prototype,"toTokenPriceInUSD",void 0);T([l()],g.prototype,"priceImpact",void 0);T([l()],g.prototype,"maxSlippage",void 0);T([l()],g.prototype,"networkTokenSymbol",void 0);T([l()],g.prototype,"inputError",void 0);g=T([C("w3m-swap-details")],g);const Y=A`
  :host {
    width: 100%;
  }
...
`;var z=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let j=class extends D{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};j.styles=[Y];z([w()],j.prototype,"target",void 0);j=z([C("w3m-swap-input-skeleton")],j);const Z=A`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var y=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};const J=5e-5;let k=class extends D{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",o=h.bigNumber(t).gt("0");return u`
    ...
    `}handleKeydown(t){return q.numericInputKeyDown(t,this.value,o=>{var i;return(i=this.onSetAmount)==null?void 0:i.call(this,this.target,o)})}dispatchInputChangeEvent(t){if(!this.onSetAmount)return;const o=t.target.value.replace(/[^0-9.]/gu,"");o===","||o==="."?this.onSetAmount(this.target,"0."):o.endsWith(",")?this.onSetAmount(this.target,o.replace(",",".")):this.onSetAmount(this.target,o)}setMaxValueToInput(){var t;(t=this.onSetMaxValue)==null||t.call(this,this.target,this.balance)}templateTokenSelectButton(){return this.token?u`
      <wui-flex
        class="swap-token-button"
        flexDirection="column"
        alignItems="flex-end"
...
`;var m=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let p=class extends D{subscribe({resetSwapState:t,initializeSwapState:o}){return()=>{$.subscribeKey("activeCaipNetwork",i=>this.onCaipNetworkChange({newCaipNetwork:i,resetSwapState:t,initializeSwapState:o})),$.subscribeChainProp("accountState",i=>{this.onCaipAddressChange({newCaipAddress:i==null?void 0:i.caipAddress,resetSwapState:t,initializeSwapState:o})})}}constructor(){var t,o,i;super(),this.unsubscribe=[],this.initialParams=(t=S.state.data)==null?void 0:t.swap,this.detailsOpen=!1,this.caipAddress=(o=$.getAccountData())==null?void 0:o.caipAddress,this.caipNetworkId=(i=$.state.activeCaipNetwork)==null?void 0:i.caipNetworkId,this.initialized=s.state.initialized,this.loadingQuote=s.state.loadingQuote,this.loadingPrices=s.state.loadingPrices,this.loadingTransaction=s.state.loadingTransaction,this.sourceToken=s.state.sourceToken,this.sourceTokenAmount=s.state.sourceTokenAmount,this.sourceTokenPriceInUSD=s.state.sourceTokenPriceInUSD,this.toToken=s.state.toToken,this.toTokenAmount=s.state.toTokenAmount,this.toTokenPriceInUSD=s.state.toTokenPriceInUSD,this.inputError=s.state.inputError,this.fetchError=s.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document!=null&&document.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=M.debounce(async()=>{await s.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),K.subscribeKey("open",r=>{r||s.resetState()}),S.subscribeKey("view",r=>{r.includes("Swap")||s.resetValues()}),s.subscribe(r=>{this.initialized=r.initialized,this.loadingQuote=r.loadingQuote,this.loadingPrices=r.loadingPrices,this.loadingTransaction=r.loadingTransaction,this.sourceToken=r.sourceToken,this.sourceTokenAmount=r.sourceTokenAmount,this.sourceTokenPriceInUSD=r.sourceTokenPriceInUSD,this.toToken=r.toToken,this.toTokenAmount=r.toTokenAmount,this.toTokenPriceInUSD=r.toTokenPriceInUSD,this.inputError=r.inputError,this.fetchError=r.fetchError,r.sourceToken&&r.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){s.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(t=>t==null?void 0:t()),clearInterval(this.interval),document==null||document.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return u`
    ...
    </wui-flex>`}async onSwitchTokens(){await s.switchTokens()}async onSwapPreview(){var t,o;this.fetchError&&await s.swapTokens(),N.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:((t=this.sourceToken)==null?void 0:t.symbol)||"",swapToToken:((o=this.toToken)==null?void 0:o.symbol)||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:F($.state.activeChain)===Q.ACCOUNT_TYPES.SMART_ACCOUNT}}),S.push("SwapPreview")}async handleSwapParameters(){this.initialParams&&(s.state.initialized||await new Promise(o=>{const i=s.subscribeKey("initialized",r=>{r&&(i==null||i(),o())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:t,fromToken:o,toToken:i}){(!s.state.tokens||!s.state.myTokensWithBalance)&&await new Promise(a=>{const c=s.subscribeKey("myTokensWithBalance",b=>{b&&b.length>0&&(c==null||c(),a())});setTimeout(()=>{c==null||c(),a()},5e3)});const r=[...s.state.tokens||[],...s.state.myTokensWithBalance||[]];if(o){const n=r.find(a=>a.symbol.toLowerCase()===o.toLowerCase());n&&s.setSourceToken(n)}if(i){const n=r.find(a=>a.symbol.toLowerCase()===i.toLowerCase());n&&s.setToToken(n)}t&&!isNaN(Number(t))&&s.setSourceTokenAmount(t)}onCaipAddressChange({newCaipAddress:t,resetSwapState:o,initializeSwapState:i}){this.caipAddress!==t&&(this.caipAddress=t,o&&s.resetState(),i&&s.initializeState())}onCaipNetworkChange({newCaipNetwork:t,resetSwapState:o,initializeSwapState:i}){this.caipNetworkId!==(t==null?void 0:t.caipNetworkId)&&(this.caipNetworkId=t==null?void 0:t.caipNetworkId,o&&s.resetState(),i&&s.initializeState())}};p.styles=ee;m([w({type:Object})],p.prototype,"initialParams",void 0);m([l()],p.prototype,"interval",void 0);m([l()],p.prototype,"detailsOpen",void 0);m([l()],p.prototype,"caipAddress",void 0);m([l()],p.prototype,"caipNetworkId",void 0);m([l()],p.prototype,"initialized",void 0);m([l()],p.prototype,"loadingQuote",void 0);m([l()],p.prototype,"loadingPrices",void 0);m([l()],p.prototype,"loadingTransaction",void 0);m([l()],p.prototype,"sourceToken",void 0);m([l()],p.prototype,"sourceTokenAmount",void 0);m([l()],p.prototype,"sourceTokenPriceInUSD",void 0);m([l()],p.prototype,"toToken",void 0);m([l()],p.prototype,"toTokenAmount",void 0);m([l()],p.prototype,"toTokenPriceInUSD",void 0);m([l()],p.prototype,"inputError",void 0);m([l()],p.prototype,"fetchError",void 0);m([l()],p.prototype,"lastTokenPriceUpdate",void 0);p=m([C("w3m-swap-view")],p);const te=A`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var E=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let P=class extends D{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var o;if(!this.visible)return null;const t=this.amount&&this.price?(o=h.multiply(this.price,this.amount))==null?void 0:o.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};P.styles=[W,H,oe];E([w()],P.prototype,"imageSrc",void 0);E([w()],P.prototype,"name",void 0);E([w()],P.prototype,"symbol",void 0);E([w()],P.prototype,"price",void 0);E([w()],P.prototype,"amount",void 0);E([l()],P.prototype,"visible",void 0);E([l()],P.prototype,"imageError",void 0);P=E([C("wui-token-list-item")],P);const ie=A`
  :host {
    width: 100%;
  }
...
`;var ne=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let R=class extends D{render(){return u`
    ...
    `}};R.styles=[W,ie];R=ne([C("wui-token-list-item-loader")],R);const re=A`
  :host {
