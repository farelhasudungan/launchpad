import{cD as g,cS as C,cT as w,cV as k,cW as $,cY as m,cZ as d,cN as l}from"./wallet.bundle.js";import{n as x,c as f,r as v}from"./index.chunk3.js";import{o as z}from"./if-defined.chunk.js";import{e as _,n as E}from"./ref.chunk.js";const h=g({isLegalCheckboxChecked:!1}),u={state:h,subscribe(e){return w(h,()=>e(h))},subscribeKey(e,t){return C(h,e,t)},setIsLegalCheckboxChecked(e){h.isLegalCheckboxChecked=e}},O=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var b=function(e,t,o,s){var n=arguments.length,c=n<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,o):s,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")c=Reflect.decorate(e,t,o,s);else for(var r=e.length-1;r>=0;r--)(i=e[r])&&(c=(n<3?i(c):n>3?i(t,o,c):i(t,o))||c);return n>3&&c&&Object.defineProperty(t,o,c),c};const P={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=_(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=P[this.size];return d`
    ...
    `}dispatchChangeEvent(){var t;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(t=this.inputElementRef.value)==null?void 0:t.checked,bubbles:!0,composed:!0}))}};a.styles=[$,O];b([x({type:Boolean})],a.prototype,"checked",void 0);b([x({type:Boolean})],a.prototype,"disabled",void 0);b([x()],a.prototype,"size",void 0);a=b([f("wui-checkbox")],a);const R=k`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
